...
The Image plugin enables the user to insert an image into TinyMCE's editable area. The plugin adds a toolbar button and an `Insert/edit image` menu item under the `Insert` menu.
